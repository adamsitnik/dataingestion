...
3. Once installed, Open the `Program.cs` file in the AspireSamples.AppHost project.
...
This template leverages JavaScript libraries to provide essential functionality. These libraries are located in the wwwroot/lib folder of the AspireSamples.Web project. For instructions on updating each dependency, please refer to the README.md file in each respective folder.
